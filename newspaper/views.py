...
class NewspaperListView(LoginRequiredMixin, generic.ListView):
    ...
    def get_queryset(self):
        queryset = Newspaper.objects.select_related("manufacturer")
...
class RedactorYearUpdateView(LoginRequiredMixin, generic.UpdateView):
    model = Redactor
    form_class = RedactorYearUpdateForm
...
def toggle_assign_to_newspaper(request, pk):
    ...
    if (
        Newspaper.objects.get(id=pk) in redactor.newpapers.all()
